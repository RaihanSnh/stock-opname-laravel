...
class ItemService{
	...
	public function store(string $code, string $name, string $description, string $series, string $total, string $vendor, ?UploadedFile $image, int $warehouse, int $category, int $unit): void 
	{
	...
	private function create($code, $name, $description, $series, $total, $warehouse, $category, $unit): DetailItem
    {
		$item = new DetailItem();
		$item->code = $code;
		$item->name = $name;
